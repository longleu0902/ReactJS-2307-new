...
function App() {
  ...
  return (
    <div className="App">
      ...
      <BrowserRouter>
        <div>
          <Nav soluong={Cart.length} Cart={Cart} setCart={setCart} removeProduct={removeProduct} removeAllProdcut={removeAllProdcut} />
          <Routes>
            <Route path="/trangchu" element={<Header />} />
          </Routes>
          <Routes>
            <Route path="/trangchu" element={<CartProduct List={List} HandleAddProduct={HandleAddProduct} />} />
            <Route path='/product/:id'element={<ShowCartProduct/>} />
            <Route path="/giohang" element={<ShoppingCart Cart={Cart} setCart={setCart} removeProduct={removeProduct}/>}/>
          </Routes>
        </div>
      </BrowserRouter>
